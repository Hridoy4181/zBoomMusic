...
$opt_name = 'zboom';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'zBoom Options', 'your-textdomain-here' ),
...
$args['share_icons'][] = array(
	'url'   => '//www.facebook.com/hridoy',
	'title' => 'Like us on Facebook',
	'icon'  => 'el el-facebook',
);
$args['share_icons'][] = array(
	'url'   => '//twitter.com/hridoy',
 ...
 * ---> START SECTIONS
 */
// We are working on the sections and fields now for zBoom theme with Redux Framework.
	...
	array(
		...
		'fields' => array(
			array(
				...
				'desc'     => __( 'You can upload your desired logo here', 'zboom', ),
				// we changed the type here from text to media to upload logo.
				'type'     => 'media',
				'id'       => 'logo-upload',
				// sometimes the logo may not show that why we will use complier.
				'complier' => true,
				'default'  => array(
	...
	array(
		...
		'fields' => array(
			array(
				...
				// we changed the type here from text to editor to make it more efficient like adding image and etc.
				'type'    => 'editor',
				'id'      => 'copyright-text',
